...
def t000001300_x9(actionbutton1=6210, flag4=6000, flag5=6001, z2=1000000, z3=1000000, z4=1000000):
    """State 0,1"""
    call = t000001300_x10(z10=2000, val6=2000)
    if call.Get() == 1:
        """State 2"""
...
def t000001300_x10(z10=_, val6=_):
    """State 0,1"""
    if f203(z10) == 1:
        """State 2"""
...
def t000001300_x12():
    """State 0,1"""
    assert t000001300_x10(z10=1101, val6=1101)
    """State 2"""
    return 0
...
def t000001300_x14():
    """State 0,1"""
    assert t000001300_x10(z10=1000, val6=1000)
    """State 2"""
    return 0
...
def t000001300_x16():
    """State 0,1"""
    assert t000001300_x10(z10=1100, val6=1100)
    """State 2"""
    return 0
...
def t000001300_x18():
    """State 0,2"""
    call = t000001300_x10(z10=1102, val6=1102)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t000001300_x19():
    """State 0,1"""
    assert t000001300_x10(z10=1001, val6=1001)
    """State 2"""
    return 0

def t000001300_x20():
    """State 0,1"""
    assert t000001300_x10(z10=1103, val6=1103)
    """State 2"""
    return 0
...
def t000001300_x24():
    """State 0,1"""
    assert t000001300_x10(z10=1104, val6=1104)
    """State 2"""
    return 0

def t000001300_x25():
    """State 0,1"""
    call = t000001300_x10(z10=1201, val6=1201)
    if call.Get() == 1:
        """State 2"""
...
def t000001300_x26():
    """State 0,1"""
    call = t000001300_x10(z10=1300, val6=1300)
    if call.Get() == 1:
        """State 2"""
        assert t000001300_x4()
    elif call.Done():
...
def t000001300_x27():
    """State 0,1"""
    call = t000001300_x10(z10=1301, val6=1301)
    if call.Get() == 1:
        """State 2"""
        assert t000001300_x4()
    elif call.Done():
...
def t000001300_x28():
    """State 0,1"""
    call = t000001300_x10(z10=1302, val6=1302)
    if call.Get() == 1:
        """State 2"""
        assert t000001300_x4()
    elif call.Done():
...
def t000001300_x32():
    """State 0,1"""
    assert t000001300_x10(z10=1002, val6=1002)
    """State 2"""
    return 0
...
def t000001300_x36():
    """State 0,1"""
    # actionbutton:6210:"Talk"
    assert (t000001300_x0(actionbutton1=6210, flag5=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000,
            flag4=6000))
    """State 4"""
    return 0
...
def t000001300_x38():
    while True:
        ...
        # Purchase Manuals
        AddTalkListData(1, 30040000, -1)
        
        # Purchase Whetstones
        AddTalkListData(2, 30040001, -1)
        
        # Leave
        AddTalkListData(99, 30020001, -1)
        ...
        if GetTalkListEntryResult() == 1:
            OpenRegularShop(2000000, 2000999)
            assert not (CheckSpecificPersonMenuIsOpen(5, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0))
        # Purchase Whetstones
        elif GetTalkListEntryResult() == 2:
            OpenRegularShop(2001000, 2001999)
            assert not (CheckSpecificPersonMenuIsOpen(5, 0) == 1 and not CheckSpecificPersonGenericDialogIsOpen(0))
        # Leave
